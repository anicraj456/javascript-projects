...
let cargoHold = [foodCabinet,equipCabinet,petCabinet,sleepCabinet];
...
if(cargoHold[userCab].includes(userItem)){
    console.log(`selected cabinet item ${userItem} is avaiable in Cabinet: ${userCab}`);
}else{
    console.log(`selected cabinet item ${userItem} is Not avaiable in Cabinet: ${userCab}`);
}
